...
| <a name="input_database_version"></a> [database\_version](#input\_database\_version) | Versão do banco de dados a ser usado na instância do Cloud SQL. | `string` | `"POSTGRES_16"` | no |
...
| <a name="input_tier"></a> [tier](#input\_tier) | Tipo de máquina para a instância do Cloud SQL. | `string` | `"db-perf-optimized-N-2"` | no |
